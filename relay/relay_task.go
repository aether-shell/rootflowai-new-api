...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	noteTaskQuotaClamp(info, ApplyTaskOtherRatios(modelName, &info.PriceData))
...
func ApplyTaskOtherRatios(modelName string, priceData *types.PriceData) *common.QuotaClamp {
	if priceData == nil || ratio_setting.IsTaskBillingModel(modelName) {
		return nil
	}
	quotaWithRatios := float64(priceData.Quota)
