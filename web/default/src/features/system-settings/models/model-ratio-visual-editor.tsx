...
>(function ModelRatioVisualEditor(
  ...
  const models = useMemo(() => {
    const savedRows = buildModelSnapshots({
      ...
      modelBillingMode: savedModelBillingMode,
  ...
  const handleEdit = useCallback(
    (model: ModelRow) => {
      ...
      setEditData({
        ...
        modelBillingMode: editableModel.modelBillingMode,
...
export const ModelRatioVisualEditor = memo(
  ...
  (prevProps, nextProps) => {
    return (
      ...
      prevProps.savedModelBillingMode === nextProps.savedModelBillingMode &&
      prevProps.modelBillingMode === nextProps.modelBillingMode &&
