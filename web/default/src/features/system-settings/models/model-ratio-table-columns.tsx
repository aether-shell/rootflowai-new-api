...
import {
  getModelBillingModeLabel,
  getModelBillingModeVariant,
  getModeLabel,
  getModeVariant,
  getPriceDetail,
  getPriceSummary,
...
export function buildModelRatioColumns({
  ...
  return [
    ...
    {
      accessorFn: (row) => row.modelBillingMode || 'default',
      id: 'modelBillingMode',
      header: ({ column }) => (
      ...
      cell: ({ row }) => (
        <StatusBadge
          ...
          variant={getModelBillingModeVariant(row.original.modelBillingMode)}
          copyable={false}
          showDot={false}
          className='-ml-1.5 px-0'
        />
